// cloud run collectors
- DEV:	terra-analytics-dev / pixel-ingest-dev
- PROD:	terra-analytics-prod / pixel-ingest-prod

// all
- pixel-ingest-dev  us-central1  https://pixel-ingest-dev-7ak5xlux7q-uc.a.run.app
- pixel-ingest-prod  us-central1  https://pixel-ingest-prod-qsnxy5imeq-uc.a.run.app
- events-collector     us-central1  https://events-collector-n576qr6ubq-uc.a.run.app
- 
