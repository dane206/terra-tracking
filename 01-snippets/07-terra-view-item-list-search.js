...
<script id="terra-view-item-list-search">
(function () {
      ...
      {% if variant and variant.id %}
        ...
        (function () {
          ...
          if (check.ok) {
            ...
            try { console.warn('[terra] view_item_list(search) invalid item', check.errors, built); } catch (e) {}
          }
        })();
